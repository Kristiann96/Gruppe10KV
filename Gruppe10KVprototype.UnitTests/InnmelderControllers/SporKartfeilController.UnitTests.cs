...
namespace Gruppe10KVprototype.Tests.Controllers
{
    ...
    public class SporKartfeilControllerTests
    {
        ...
        [TestMethod]
        [Description("Verifiserer at kontrolleren h�ndterer en tom GeoJSON-streng ved � returnere en BadRequest med korrekt feilmelding")]
        ...
        [TestMethod]
        [Description("Verifiserer at kontrolleren h�ndterer en ugyldig GeoJSON-streng ved � returnere en BadRequest med korrekt feilmelding")]
        ...
        [TestMethod]
        [Description("Verifiserer at kontrolleren h�ndterer en null GeoJSON-verdi ved � returnere en BadRequest med korrekt feilmelding")]
        ...
        [TestMethod]
        [Description("Verifiserer at kontrolleren videresender til riktig action med korrekte parametere n�r en gyldig GeoJSON blir sendt inn")]
